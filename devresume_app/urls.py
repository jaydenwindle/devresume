...
urlpatterns = [
    ...
    url(r'^applications/create/$', ApplicationEntryCreate.as_view(), name='create_application_entry'),
    url(r'^applications/(?P<pk>[\w-]+)/edit/$', ApplicationEntryUpdate.as_view(), name='edit_application_entry'),
    url(r'^applications/(?P<pk>[\w-]+)/delete/$', ApplicationEntryDelete.as_view(), name='delete_application_entry'),
